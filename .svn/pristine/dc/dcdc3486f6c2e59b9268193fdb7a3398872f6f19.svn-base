...
class PageTools{
    ...
    public function showPage($page,$pagesize,$total,$url,$param_page=array()){
        ...
        总页数为<span>$total_page</span>页，
        每页显示<input type="text" value="$pagesize" onblur="window.location.href='$url'+'1'+'&pagesize='+this.value" size="3" id="pege_input" />条数据，
HTML;
        #链接部分,上下页形成一个循环
        ...
        <li><a href="{$url}{$prev}">上一页</a></li>
        <li><a href="{$url}{$next}">下一页</a></li>
