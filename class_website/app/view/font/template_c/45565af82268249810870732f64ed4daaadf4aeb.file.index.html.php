<?php /* Smarty version Smarty-3.1.14, created on 2018-05-18 16:56:00
         compiled from "F:\PHPStudy\WWW\16jsjgj\class_website\app\view\font\index.html" */ ?>
<?php /*%%SmartyHeaderCode:21415af657f5b5e4e1-80580825%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '45565af82268249810870732f64ed4daaadf4aeb' => 
    array (
      0 => 'F:\\PHPStudy\\WWW\\16jsjgj\\class_website\\app\\view\\font\\index.html',
      1 => 1526633759,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '21415af657f5b5e4e1-80580825',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5af657f5c50821_89824638',
  'variables' => 
  array (
    'webset' => 0,
    'naviga_list' => 0,
...
<?php if ($_valid && !is_callable('content_5af657f5c50821_89824638')) {function content_5af657f5c50821_89824638($_smarty_tpl) {?><html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta charset="utf-8" />
...
"><?php echo $_smarty_tpl->tpl_vars['naviga']->value['naviga_name'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['switch_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['switch']->index=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['switch']->key => $_smarty_tpl->tpl_vars['switch']->value){
$_smarty_tpl->tpl_vars['switch']->_loop = true;
 $_smarty_tpl->tpl_vars['switch']->index++;
?>
                        <?php if ($_smarty_tpl->tpl_vars['switch']->value['switchable_show']==1&&$_smarty_tpl->tpl_vars['switch']->index<4){?>
                        <a data-shutter-title="<?php echo $_smarty_tpl->tpl_vars['switch']->value['switchable_name'];?>
"><img src="./app/uploaded/<?php echo $_smarty_tpl->tpl_vars['switch']->value['switchable_images'];?>
" alt="#"></a>
                        <?php }?>
                        <?php } ?>
                    </div>
                    ...
                    <div class="shutter-desc">
                        <p><?php echo $_smarty_tpl->tpl_vars['switch']->value['switchable_name'];?>
</p>
                    </div>
                </div>
...
?>
                <?php if ($_smarty_tpl->tpl_vars['work']->value['work_title']=="班级介绍"&&$_smarty_tpl->tpl_vars['work']->value['work_show']==1&&$_smarty_tpl->tpl_vars['i']->value++<=1){?>
...
" style="max-height:300px;max-width:auto;" />
                    ...
                    <div id="introduce-right" style="max-height:200px;max-width:auto;">
...
$_smarty_tpl->tpl_vars['work']->_loop = true;
?>
                    <?php if ($_smarty_tpl->tpl_vars['work']->value['work_show']==1&&$_smarty_tpl->tpl_vars['work']->value['work_title']=='昔日风采'&&$_smarty_tpl->tpl_vars['i']->value++<=6&&$_smarty_tpl->tpl_vars['work']->value['work_hot']==1){?>
                    <div class="view view-seventh">
                        <img src="./app/uploaded/<?php echo $_smarty_tpl->tpl_vars['work']->value['work_images'];?>
" style="max-width:300;max-height:auto;" />
                        <div class="mask">
                            <div><?php echo $_smarty_tpl->tpl_vars['work']->value['work_content'];?>
</div> 
