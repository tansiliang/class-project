<?php /* Smarty version Smarty-3.1.14, created on 2018-05-18 17:44:46
         compiled from "F:\PHPStudy\WWW\16jsjgj\class_website\app\view\font\detail.html" */ ?>
<?php /*%%SmartyHeaderCode:320215afe8633a7a768-60275610%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81d23c64bbd804199f1239f367e2da22713ef118' => 
    array (
      0 => 'F:\\PHPStudy\\WWW\\16jsjgj\\class_website\\app\\view\\font\\detail.html',
      1 => 1526636684,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '320215afe8633a7a768-60275610',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_5afe8633afb601_20203025',
  'variables' => 
  array (
    'webset' => 0,
    'naviga_list' => 0,
...
<?php if ($_valid && !is_callable('content_5afe8633afb601_20203025')) {function content_5afe8633afb601_20203025($_smarty_tpl) {?><html lang="en" xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta charset="utf-8" />
...
"><?php echo $_smarty_tpl->tpl_vars['naviga']->value['naviga_name'];?>
    ...
    <div class="page" style="margin-bottom:10px;">
        ...
        <div class="left" style="">
            <?php echo $_smarty_tpl->tpl_vars['work_list']->value['work_content'];?>

        </div>
        <div class="right">
            <p class="tuijian">推荐列表</p>
            <ul class="right_ul">
...
?>
                <?php if ($_smarty_tpl->tpl_vars['row']->value['work_show']==1&&$_smarty_tpl->tpl_vars['row']->value['work_title']=='昔日风采'&&$_smarty_tpl->tpl_vars['row']->value['work_hot']==1){?>
                <li><a href="index.php?p=font&c=Mien&a=detail"><?php echo $_smarty_tpl->tpl_vars['row']->value['work_subtitle'];?>
</a></li>
                <?php }?>
                <?php } ?>
            </ul>
